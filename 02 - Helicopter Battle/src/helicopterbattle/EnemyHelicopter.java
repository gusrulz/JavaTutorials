...
public class EnemyHelicopter {
	...
	// Offset for the propeller. We add offset to the position of the helicopter.
	...
	public static void speedUp() {
		...
		if(EnemyHelicopter.timeBetweenNewEnemies > Framework.secInNanosec) {
			...
			EnemyHelicopter.timeBetweenNewEnemies -= Framework.secInNanosec;
		}
	...
	/**
	 * Checks if the enemy has left the screen.
	 * 
	 * @return true if the enemy has left the screen, false otherwise.
	 */
	...
	public void Update() {
		...
		// Moves helicopter propeller animations with helicopter.
