...
public class Bullet {
	...
	// Damage that is mage to an enemy helicopter when it is hit with a bullet.
	 ...
	 * 
	 * @return true if the bullet has left the screen, false otherwise.
	 */
	public boolean hasItLeftTheScreen() {
