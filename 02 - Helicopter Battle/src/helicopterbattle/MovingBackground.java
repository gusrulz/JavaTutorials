...
public class MovingBackground {
	...
	/**
	 * Intialize object for moving image.
	 * 
	 * @param image Image that will be moving.
	 * @param speed How fast and into which direction should the image move?
	...
	public void Initialize(BufferedImage image, double speed, int yPosition) {
		...
		// We divide frame size by image size do that we get how many times we need to draw image to screen.
